...
export const metadata = {
  ...
  description:
    "Ecommerce con los productos de la categoria camisa, pantalon, chaqueta, sudadera, camiseta, zapato, etc.",
  keywords:
    "Ecommerce, ropa, Zara, moda, tienda, online, shopping, tienda de ropa, camisa, pantalon, chaqueta, sudadera, camiseta, zapato, etc.",
};
